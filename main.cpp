...
int main()
{
    ...
    motorcycles.emplace_back("simon");
    motorcycles.emplace_back("alvin");
    motorcycles.emplace_back("abby");

    trucks.reserve(3);
    trucks.emplace_back("vanessa");
    trucks.emplace_back("jacob");
